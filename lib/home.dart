    ...
    return  Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(image: AssetImage('assets/undraw_certificate_re_yadi.svg'),
          fit: BoxFit.cover
          )
        ),
        child: Column(
                  ...
                  Center(
                    child: TextButton(onPressed: selectPhotoFromGallery,
                        ...
                        child: Container(
                          ...
                          child: _image!=null? Image.file(_image!, height: 360.0, width: 400.0,fit: BoxFit.cover,) : Container(
                            width: 140.0,
                            height: 190.0,
                            child: const Icon(
                              Icons.image_search,
